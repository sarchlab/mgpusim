...
__kernel void MaxPoolForward(int nthreads, __global float* bottom_data, int num, int channels, int height, int width, int pooled_height, int pooled_width, int kernel_h, int kernel_w, int stride_h, int stride_w, int pad_h, int pad_w, __global float* top_data, __global int* mask_data) {
