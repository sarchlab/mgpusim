...
//go:generate mockgen -destination "mock_training_test.go" -package $GOPACKAGE -self_package $GOPACKAGE -write_package_comment=false github.com/sarchlab/mgpusim/v3/benchmarks/dnn/training LossFunction,DataSource
...
//go:generate mockgen -destination "mock_optimization_test.go" -package $GOPACKAGE -write_package_comment=false github.com/sarchlab/mgpusim/v3/benchmarks/dnn/training/optimization Alg
