...
type KernelTrace struct {
	...
	tbIDToIndex map[nvidiaconfig.Dim3]int32
...
type KernelFileHeader struct {
	...
	GridDim               nvidiaconfig.Dim3 `title:"grid dim"`
	BlockDim              nvidiaconfig.Dim3 `title:"block dim"`
...
type Instruction struct {
	threadblockID nvidiaconfig.Dim3
	warpID        int32
