// Package branchdiv50pct implements 50% branch divergence microbenchmark.
package branchdiv50pct
...
// KernelArgs defines kernel arguments for branch_div_50pct_kernel.
...
// Benchmark defines the branch divergence 50% benchmark.
...
// NewBenchmark creates a new branch divergence 50% benchmark.
...
func (b *Benchmark) loadProgram() {
	b.kernel = insts.LoadKernelCodeObjectFromBytes(
		hsacoBytes, "branch_div_50pct_kernel")
	if b.kernel == nil {
		log.Panic("Failed to load branch_div_50pct_kernel")
	}
}
...
func (b *Benchmark) Verify() {
	...
	if errors > 0 {
		log.Panicf("FAIL: %d errors in branch_div_50pct verification", errors)
	}
	log.Printf("Passed!")
}
