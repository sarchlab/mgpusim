// Package sfunsin implements special function (sin) throughput microbenchmark.
package sfunsin
...
// KernelArgs defines kernel arguments for sfun_sin_kernel.
...
// Benchmark defines the sfun_sin benchmark.
...
// NewBenchmark creates a new sfun_sin benchmark.
...
func (b *Benchmark) loadProgram() {
	b.kernel = insts.LoadKernelCodeObjectFromBytes(
		hsacoBytes, "sfun_sin_kernel")
	if b.kernel == nil {
		log.Panic("Failed to load sfun_sin_kernel")
	}
}
