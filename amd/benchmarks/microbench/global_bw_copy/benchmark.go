// Package globalbwcopy implements global memory bandwidth copy microbenchmark.
package globalbwcopy
...
// KernelArgs defines kernel arguments for global_bw_copy_kernel.
...
// Benchmark defines the global bandwidth copy benchmark.
...
// NewBenchmark creates a new global bandwidth copy benchmark.
...
func (b *Benchmark) loadProgram() {
	b.kernel = insts.LoadKernelCodeObjectFromBytes(
		hsacoBytes, "global_bw_copy_kernel")
	if b.kernel == nil {
		log.Panic("Failed to load global_bw_copy_kernel")
	}
}
...
func (b *Benchmark) Verify() {
	...
	if errors > 0 {
		log.Panicf("FAIL: %d errors in global_bw_copy verification", errors)
	}
	log.Printf("Passed!")
}
