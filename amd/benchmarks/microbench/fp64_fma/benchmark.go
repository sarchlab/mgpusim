// Package fp64fma implements FP64 fused multiply-add throughput microbenchmark.
package fp64fma
...
// KernelArgs defines kernel arguments for fp64_fma_kernel.
...
// Benchmark defines the FP64 FMA benchmark.
...
// NewBenchmark creates a new FP64 FMA benchmark.
...
func (b *Benchmark) loadProgram() {
	b.kernel = insts.LoadKernelCodeObjectFromBytes(
		hsacoBytes, "fp64_fma_kernel")
	if b.kernel == nil {
		log.Panic("Failed to load fp64_fma_kernel")
	}
}
...
func (b *Benchmark) initMem() {
	numThreads := 65536
	bytes := uint64(numThreads * 8) // 8 bytes per double
