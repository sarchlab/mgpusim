...
//
//	mockgen -destination mock_tensor_test.go -package training -write_package_comment=false github.com/sarchlab/mgpusim/v4/amd/benchmarks/dnn/tensor Tensor,Operator
//
