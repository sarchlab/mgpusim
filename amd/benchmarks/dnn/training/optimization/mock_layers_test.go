...
//
//	mockgen -destination mock_layers_test.go -package optimization -write_package_comment=false github.com/sarchlab/mgpusim/v4/amd/benchmarks/dnn/layers Layer
//
