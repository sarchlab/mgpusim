...
// One transaction may carry multiple incoming requests: the translator
// coalesces requests that target the same virtual page and PID onto one
// in-flight translation (see parseTranslateMW.translate). TranslationVAddr
// and TranslationPID record the page the translation was issued for so
// later requests can match against it.
type transactionState struct {
	...
	TranslationVAddr  uint64               `json:"translation_v_addr"`
	TranslationPID    vm.PID               `json:"translation_pid"`
