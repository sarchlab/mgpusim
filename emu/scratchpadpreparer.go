...
type ScratchpadPreparer interface {
	...
	// scratchpad
	Prepare(instEmuState InstEmuState, regInterface RegInterface, wf interface{})

	// Commit write to the register file to reflect the change in the scratchpad
	Commit(instEmuState InstEmuState, regInterface RegInterface, wf interface{})
}

// ScratchpadPreparerImpl provides a standard implementation of the
// ScratchpadPreparer
