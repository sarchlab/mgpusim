...
func (d *Disassembler) initializeDecodeTable() {
	...
	d.addInstType(&InstType{"v_add_f64", 640, FormatTable[VOP3a], 0, ExeUnitVALU})
	d.addInstType(&InstType{"v_mul_f64", 641, FormatTable[VOP3a], 0, ExeUnitVALU})
	d.addInstType(&InstType{"v_min_f64", 642, FormatTable[VOP3a], 0, ExeUnitVALU})
	d.addInstType(&InstType{"v_max_f64", 643, FormatTable[VOP3a], 0, ExeUnitVALU})
