...
func (d *Disassembler) initializeDecodeTable() {
	...
	d.addInstType(&InstType{"flat_load_ubyte", 16, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_load_sbyte", 17, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_load_ushort", 18, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_load_sshort", 19, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_load_dword", 20, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_load_dwordx2", 21, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_load_dwordx4", 22, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_load_dwordx3", 23, FormatTable[Flat], 0, ExeUnitVMem})
	// Unitl here
	d.addInstType(&InstType{"flat_store_byte", 24, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_store_short", 26, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_store_dword", 28, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_store_dwordx2", 29, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_store_dwordx4", 30, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_store_dwordx3", 31, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_swap", 48, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_cmpswap", 49, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_add", 50, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_sub", 51, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_smin", 53, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_umin", 54, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_smax", 55, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flag_atomic_umax", 56, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_and", 57, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_or", 58, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_xor", 59, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_inc", 60, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_dec", 61, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_swap_x2", 80, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_cmpswap_x2", 81, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_add_x2", 82, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_sub_x2", 83, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_smin_x2", 85, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_umin_x2", 86, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_smax_x2", 87, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_umax_x2", 88, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_and_x2", 89, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_or_x2", 90, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_xor_x2", 91, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_inc_x2", 92, FormatTable[Flat], 0, ExeUnitVMem})
	d.addInstType(&InstType{"flat_atomic_dec_x2", 93, FormatTable[Flat], 0, ExeUnitVMem})
