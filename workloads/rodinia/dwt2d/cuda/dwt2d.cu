// dwt2d.cu -- CUDA benchmark for Rodinia 2D Discrete Wavelet Transform
...
// For each row, compute average and difference of adjacent pairs
...
int main(int argc, char **argv) {
    ...
    BenchResult r = runBenchmark("dwt2d", problemSize, iterations, [&]() {
        // Upload image
        CUDA_CHECK(cudaMemcpy(d_input, h_image, total * sizeof(float),
        ...
        for (int l = 0; l < levels; l++) {
            ...
            CUDA_CHECK(cudaMemcpy(d_input, d_output, total * sizeof(float),
